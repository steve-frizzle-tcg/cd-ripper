...
def main():
    # Check for simple mode (just list missing covers and exit)
    ...
    # If in simple mode, just exit after showing the list
    if simple_mode:
        print(f"\n✅ Scan complete. Use interactive mode for cover management.")
        return 0
